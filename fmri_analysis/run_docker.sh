...
docker run -ti --rm -p 8888:8888 -v `pwd`/output/:/output -v /mnt/Sherlock_Scratch/output/1stLevel:/scratch:ro  -v /mnt/Data/:/Data:ro nipype_image /output --script group_analysis.py --tasks stroop --mask_dir /Data --data_dir /scratch
