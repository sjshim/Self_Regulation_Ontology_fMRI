...
docker run -ti --rm -p 8888:8888 -v `pwd`/output/Plots:/output -v /mnt/Sherlock_Scratch/datasink/1stLevel:/Data:ro  nipype_image /output --script group_plots.py --tasks stroop  
